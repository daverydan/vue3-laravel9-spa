                ...
                <thead>
                    ...
                    <tr>
                        <th class="px-6 py-3 bg-gray-50 text-left">
                            ...
                            >
                                <div
                                    class="text-xs mr-2 leading-4 font-medium text-gray-500 uppercase tracking-wider"
                                    :class="{
                        ...
                        <th
                            class="px-6 py-3 bg-gray-50 text-center"
                            style="width: 152px"
                        >
                    ...
                    <tr v-for="post in posts.data">
                        ...
                        >
                            <router-link
                                ...
                                class="px-2 py-1 bg-gray-100 hover:bg-gray-200 rounded-sm transition duration-200 ease-in-out"
                                >Edit</router-link
                            >
                            <a
